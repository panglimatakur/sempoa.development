        ...
        <div class="ibox float-e-margins">
			...
			if(!empty($direction)){
                ...
                <div class='alert alert-warning' style="margin:0">
                    <ol><i class="icon-plus"></i> Berfungsi Untuk Menambah Sub Jenis Transaksi</ol>
                    <ol><i class="icon-pencil"></i> Berfungsi Untuk Memperbaiki Jenis Transaksi</ol>
                    <ol><i class="icon-trash"></i> Berfungsi Untuk Menghapus Jenis Transaksi</ol>
                </div>
            <?php } ?>
            </div>
