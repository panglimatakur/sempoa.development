<?php
		...
		WHERE 
			...
			".$req_condition."
			AND (ID_DISTRIBUTION_STATUS = '15' OR ID_DISTRIBUTION_STATUS = '16' AND ID_DISTRIBUTION_STATUS != '5')
		ORDER BY 
        ...
        <tbody>
          ...
          <tr id="tr_req_<?php echo $dt_shipping_branch->ID_PRODUCT_DISTRIBUTION; ?>">
            <td style="vertical-align:top; position:relative;" >
                ...
                <span class='code'>
                    <strong>Dari</strong> : <?php echo $client; ?>
                </span>
                <br />
                    ...
                    <thead>
                     ...
                     ?>
                        ...
                        <tr id="td_<?php echo $dt_kolektif->ID_PRODUCT_STOCK; ?>">
                            ...
                            <td >
                            	<?php if(allow('edit') == 1){ ?>
                                <a href='<?php echo $ajax_dir; ?>/catatan.php?page=<?php echo $page; ?>&direction=edit&type=request&id_stock=<?php echo $dt_kolektif->ID_PRODUCT_STOCK; ?>' class="btn btn-mini fancybox fancybox.ajax" title="Perbaiki Permintaan <?php echo $code; ?>">
            ...
            <td style="vertical-align:top; position:relative;" >
					<?php if(allow('edit') == 1){?>
                    <a href='<?php echo $ajax_dir; ?>/status.php?id_product_distribution=<?php echo $dt_shipping_branch->ID_PRODUCT_DISTRIBUTION; ?>&type=request' class="btn btn-mini fancybox fancybox.ajax" title="Ubah Status Permintaan">
