...
<div class='w-box'>
	...
	<?php if(empty($direction)){?>
        ...
        <select name="item_type" id="item_type" style="width:20%; margin:8px 0 9px 9px">
            <?php
        ...
        <div id="dt_list">
            <table width="100%" class="table table-striped">
              ...
              <tbody>
                ...
                ?>
                      <tr id="tr_<?php echo @$id_product; ?>" class="product_list">
                        <td>
                            <?php if(!empty($photo) && is_file($basepath."/files/images/products/".$id_client."/thumbnails/".$photo)){ ?>
                                <img src='<?php echo $dirhost; ?>/files/images/products/<?php echo $id_client; ?>/thumbnails/<?php echo $photo; ?>' class="photo" style="width:100%"/>
                            <?php }else{ ?>
                                <img src='<?php echo $dirhost; ?>/files/images/no_image.jpg' class="photo" style="width:100%"/>
                            <?php } ?>
                        </td>
                <?php
