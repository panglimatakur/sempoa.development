...
<div id="print_wrapper">
		<?php echo print_header("Rekapitulasi Keuangan<br>Periode ".$label.""); ?>
                ...
                <tbody>
				  <?php
                      while($r<$parameter){ 
                        ...
                        $q_cash	 	= $db->query("SELECT SUM(CASH_VALUE) AS JML,ID_CASH_TYPE FROM ".$tpref."cash_flow WHERE (ID_CLIENT='".$_SESSION['cidkey']."' ".parent_condition($_SESSION['cidkey']).") ".$condition."");
                  ...
                  <?php 
                    ...
                    $q_total 	= $db->query("SELECT SUM(CASH_VALUE) JUMLAHNYA FROM ".$tpref."cash_flow WHERE (ID_CLIENT='".$_SESSION['cidkey']."' ".parent_condition($_SESSION['cidkey']).") ".$condition3." ");
