...
<div class="features_items"><!--features_items-->
    <h2 class="title text-center">Promo Discoin Diskon</h2>
        ...
        if($num_discount > 0 || !empty($client_statement)){
            if($num_discount > 0){
                ...
                echo  "
					<h2  class='title text-center' style='margin:4px 0 3px 0;'>Diskon ".$o."</h2>
					<div style='clear:both; margin:0 0 3px 17px; text-align:justify; line-height:normal'>
