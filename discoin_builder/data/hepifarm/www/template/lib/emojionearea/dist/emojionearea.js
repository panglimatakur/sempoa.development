...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        self.emojiTemplate = '<img alt="{alt}" class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}" style="width:16px"/>');
    ...
    var cdn = {
        defaultBase : dirhost+"/libraries/emojione/",
        defaultBase3: dirhost+"/libraries/",
        base        : null,
        isLoading   : false
    };
